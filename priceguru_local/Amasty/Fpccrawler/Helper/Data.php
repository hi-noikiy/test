...
class Amasty_Fpccrawler_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        $ignore     = Mage::getStoreConfig('amfpccrawler/queue/ignore_list');
    ...
    {
        $user = 'FPC.Crawler.' . $customerGroup;
    ...
    {
        $username = 'FPC.Crawler.' . $customerGroup;
