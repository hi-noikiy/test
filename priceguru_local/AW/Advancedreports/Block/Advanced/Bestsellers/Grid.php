...
class AW_Advancedreports_Block_Advanced_Bestsellers_Grid extends AW_Advancedreports_Block_Advanced_Grid
{
    ...
    public function prepareReportCollection()
    {
        ...
        $collection = $this->getAggregator()->getAggregatetCollection();
         $collection->getSelect()->join('catalog_product_entity_varchar as product','product.entity_id=main_table.product_id && product.attribute_id="1020"', array('new_sku'=>'value'));
    ...
    */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'new_sku',
            array(
                 'header'   => Mage::helper('reports')->__('Subtitle'),
                 'index'    => 'new_sku',
                 'type'     => 'text',
            )
        );
