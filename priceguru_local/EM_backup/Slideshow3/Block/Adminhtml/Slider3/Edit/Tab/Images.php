<?php
class EM_Slideshow3_Block_Adminhtml_Slider_Edit_Tab_Images extends Mage_Adminhtml_Block_Widget_Form
{
	...
	public function _toHtml(){
		$this->setTemplate('em_slideshow3/slider_img.phtml');

		$data	=	unserialize(base64_decode(Mage::registry('slideshow3_data')->getImages()));
