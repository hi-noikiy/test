<?php 
Class EM_Customercomment2_Model_Mysql4_Customercomment2_Order extends Mage_Core_Model_Mysql4_Abstract {
	public function _construct()
	{
		$this->_init('customercomment2/customercomment2_order', 'id');
	}
