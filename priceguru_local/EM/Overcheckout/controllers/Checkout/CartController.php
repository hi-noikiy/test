...
class EM_Overcheckout_Checkout_CartController extends Mage_Checkout_CartController{
    ...
    public function addAction()
    {
        ...
        try {
            ...
            if (!$this->_getSession()->getNoCartRedirect(true)) {
				...
				{
					$yourModel = Mage::getModel('checkout/cart');
					$check=$yourModel->isMobileCart();
					// print_r($check);
					// die;
					if($check=="0")
					{
