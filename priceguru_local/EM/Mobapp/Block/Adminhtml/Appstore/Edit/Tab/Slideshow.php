<?php
class EM_Mobapp_Block_Adminhtml_Appstore_Edit_Tab_Slideshow extends Mage_Adminhtml_Block_Widget_Form
{
	...
	public function _toHtml(){
		$this->setTemplate('em_mobapp/manage_slide.phtml');

		$data	=	Mage::registry('mobapp_data');
		$slide	=	Mage::helper("mobapp")->jsonDecode($data->getData('slideshow'));
		$slide2	=	Mage::helper("mobapp")->jsonDecode($data->getData('slideshow2'));
