...
class EM_Link_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    {	
		...
		$templateId = 8;//here you can use template id defined in XML or you can use template ID in database (would be 1,2,3,4 .....etc)
		...
		$sender = array('name' => 'PriceGuru.mu',
		'email' => 'info@priceguru.mu');
