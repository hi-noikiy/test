...
class EM_SendSMS_Adminhtml_SendSMSController extends Mage_Adminhtml_Controller_action
{
    ...
    public function massStatusAction()
    {
        ...
        if(!is_array($sendsmsIds)) {
            ...
            try {
                foreach ($sendsmsIds as $sendsmsId) {
                    $sendsms = Mage::getSingleton('sendsms/sendsms')
                        ->load($sendsmsId)
                ...
                $this->_getSession()->addSuccess(
                    $this->__('Total of %d record(s) were successfully updated', count($sendsmsIds))
                );
            } catch (Exception $e) {
    ...
    {
        $fileName   = 'sendsms.csv';
        $content    = $this->getLayout()->createBlock('sendsms/adminhtml_sendsms_grid')
            ->getCsv();
