...
class EM_Onestepcheckout_Block_Adminhtml_Deliveryorder_Grid_Renderer_Deliverycomment extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Input {
/*
 ...
 */
    public function render(Varien_Object $row)
    {
        ...
        $html = '<textarea id="delivery_comment'.$row->getDeliveryId().'" class="input-text" name="'.$this->getColumn()->getId().'" type="text">'.$row->getData($this->getColumn()->getIndex()).'</textarea>';
