...
class EM_Onestepcheckout_Block_Adminhtml_Pickuporder_Grid_Renderer_Wholesaler extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Input {
/*
 ...
 */
    public function render(Varien_Object $row)
    {
        ...
        $wholesalers = Mage::getSingleton('onestepcheckout/wholesaler')->getCollection();
        /*if($rowval == 1) {
