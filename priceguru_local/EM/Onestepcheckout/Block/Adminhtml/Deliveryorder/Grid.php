...
class EM_Onestepcheckout_Block_Adminhtml_Deliveryorder_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('telephone', array(
        ...
        'align'     =>'left',
        'index'     => 'telephone',
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_telephone'
    ));

    $this->addColumn('address', array(
      'header'    => Mage::helper('onestepcheckout')->__('Address'),
      'index'     => 'address',
      'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_address'
    ));
    ...
    $this->addColumn('region', array(
        ...
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_region'
    ));
    ...
    $this->addColumn('attributes', array(
        ...
        'align'     =>'left',
        'index'     => 'attributes',
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_attributes',
    ));
    ...
    $this->addColumn('payment_method', array(
        ...
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_payment',
    ));
    ...
    $this->addColumn('deposit', array(
        ...
        'align'     =>'left',
        'index'     => 'deposit',
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_deposit',
    ));
    ...
    $this->addColumn('customer_comment', array(
        ...
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_customercomment',
    ));
    ...
    $this->addColumn('delivery_comment', array(
        ...
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_deliverycomment',
    ));
    ...
    $this->addColumn('delivery_date_time', array(
        ...
        'type' => 'datetime',
        'width' => '100px',
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_deliverydate',
    ));
    ...
    $this->addColumn('status', array(
        ...
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_status',
    ));

    $this->addColumn('delivery_time', array(
        'header' => Mage::helper('onestepcheckout')->__('Delivery Time'),
        'index' => 'delivery_time',
        'renderer'  => 'onestepcheckout/adminhtml_deliveryorder_grid_renderer_deliverytime',
    ));
