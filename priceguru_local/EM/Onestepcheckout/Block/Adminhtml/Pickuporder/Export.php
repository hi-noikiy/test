...
class EM_Onestepcheckout_Block_Adminhtml_Pickuporder_Export extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('telephone', array(
        ...
        'align'     =>'left',
        'index'     => 'telephone',
        'renderer'  => 'onestepcheckout/adminhtml_pickuporder_grid_renderer_telephone'
    ));

    $this->addColumn('address', array(
      'header'    => Mage::helper('onestepcheckout')->__('Address'),
      'index'     => 'address',
      'renderer'  => 'onestepcheckout/adminhtml_pickuporder_grid_renderer_address'
    ));

    $this->addColumn('region', array(
        'header' => Mage::helper('onestepcheckout')->__('Region'),
        'index' => 'region',
        'renderer'  => 'onestepcheckout/adminhtml_pickuporder_grid_renderer_region'
    ));*/
