...
class EM_Onestepcheckout_Block_Adminhtml_Cimcreditorder_Export extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('attributes', array(
        ...
        'align'     =>'left',
        'index'     => 'attributes',
        //'renderer'  => 'onestepcheckout/adminhtml_cimcreditorder_grid_renderer_attributes',
    ));
