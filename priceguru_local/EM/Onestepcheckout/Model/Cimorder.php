...
class EM_Onestepcheckout_Model_Cimorder extends Mage_Core_Model_Abstract
{
    ...
    {
        parent::_construct();
        $this->_init('onestepcheckout/cimorder');
    }
    ...
    public function createOrder($products, $customerdata)
    {
        ...
        $salescimorder = Mage::getModel('onestepcheckout/salescimorder');
