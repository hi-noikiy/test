<?php
class EM_Addphone_Block_Adminhtml_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account
{
    /**
     * Initialize block
     */
    ...
    public function initForm()
    {
        ...
        $form->getElement('group_id')->setRenderer($this->getLayout()
			...
			if ($customer->getId())
			{
				...
				$tel=$customer_data->getData('mobile');
			}
		  // $field2=$fieldset->addField('show_telephone', 'text',
                    // array(
							// 'label'     => $tel,
			...
			// $field2->setRenderer($this->getLayout()->createBlock('adminhtml/customer_grid_renderer_test2'));
        if ($customer->getId()) {
