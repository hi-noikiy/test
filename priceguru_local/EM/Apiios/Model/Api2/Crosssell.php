 ...
 */
class EM_Apiios_Model_Api2_Crosssell extends Mage_Core_Model_Abstract
{
    /**
    ...
    {
        return Mage::getSingleton('apiios/api2_checkout_session')->setStore($this->getStore())->getQuote();
    }
