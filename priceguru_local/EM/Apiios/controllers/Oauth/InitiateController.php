 ...
 * @category    EM
 * @package     EM_Apiios
 * @author      Emthemes Team <emthemes.com>
 */
class EM_Apiios_Oauth_InitiateController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function preDispatch()
    {
        ...
        $this->setFlag('', self::FLAG_NO_PRE_DISPATCH, 0);
