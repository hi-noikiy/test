...
class Ktpl_Customreport_Block_Adminhtml_Purchaseorder_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('created_date', array(
        'header' => Mage::helper('customreport')->__('Invoice Date'),
        'index' => 'created_date',
        'type' => 'datetime',
        'width' => '100px',
    ));
    ...
    $this->addColumn('wholesaler_id', array(
      ...
      'renderer'  => 'customreport/adminhtml_purchaseorder_grid_renderer_wholesaler',
    ));
