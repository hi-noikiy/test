...
class Ktpl_Customreport_Block_Adminhtml_Purchaseorder_Grid_Renderer_Wholesaler extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Input {
/*
 ...
 */
    public function render(Varien_Object $row)
    {
        ...
        $wholesalers = Mage::getSingleton('customreport/wholesaler')->load($rowval);
