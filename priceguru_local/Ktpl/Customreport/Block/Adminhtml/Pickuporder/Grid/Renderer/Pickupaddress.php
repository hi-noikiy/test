 ...
 */
    public function render(Varien_Object $row)
    {
        ...
        $html = '<textarea rows="3" id="pickupaddress'.$row->getPickupId().'" class="input-text" name="'.$this->getColumn()->getId().'" type="text">'.$row->getData($this->getColumn()->getIndex()).'</textarea>';
