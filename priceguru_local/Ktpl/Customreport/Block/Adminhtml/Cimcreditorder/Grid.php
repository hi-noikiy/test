...
class Ktpl_Customreport_Block_Adminhtml_Cimcreditorder_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareCollection()
  {
      ...
      $collection->getSelect()->join('sales_flat_order', 'main_table.order_id = sales_flat_order.increment_id',array('entity_id','status','subtotal','order_currency_code', 'created_at'));
  ...
  protected function _prepareColumns()
  {
    ...
    $this->addColumn('dcp', array(
        ...
        'align'     =>'left',
        'index'     => 'dcp',
        'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_dcpinput',
    ));
    ...
    $this->addColumn('installments', array(
     		...
     		'align'     =>'left',
        'index'     => 'installments',
        'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_installinput',
    ));
    ...
    $this->addColumn('monthly', array(
      ...
      'width' => '100px',
      'index'     => 'monthly',
      'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_monthlyinput',
    ...
    $this->addColumn('deposit', array(
        ...
        'align'     =>'left',
        'index'     => 'deposit',
        'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_deposit',
    ));
    ...
    $this->addColumn('cpp', array(
        ...
        'align'     =>'left',
        'index'     => 'cpp',
        'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_cppinput',
    ));
    ...
    $this->addColumn('payment', array(
        ...
        'align'     =>'left',
        'index'     => 'payment',
        'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_payment',
    ));
    ...
    $this->addColumn('app_number', array(
        ...
        'align'     =>'left',
        'index'     => 'app_number',
        'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_appnumber',
    ));
    ...
    $this->addColumn('pgcomment', array(
        ...
        'sortable'  => false,
        'index'     => 'pgcomment',
        'renderer'  => 'customreport/adminhtml_cimcreditorder_grid_renderer_pgcomment'
    ));
