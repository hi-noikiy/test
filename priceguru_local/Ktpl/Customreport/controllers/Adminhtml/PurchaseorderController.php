...
class Ktpl_Customreport_Adminhtml_PurchaseorderController extends Mage_Adminhtml_Controller_Action {
        ...
        if(!is_array($pickupIds)) {
            ...
            try {
                foreach ($pickupIds as $pickupId) {
                    $pickuporder = Mage::getModel('customreport/salespickuporder')->load($pickupId);
    ...
    public function exportCsvAction() {
        ...
        $content = $this->getLayout()->createBlock('customreport/adminhtml_purchaseorder_grid')
                        ->getCsv();
