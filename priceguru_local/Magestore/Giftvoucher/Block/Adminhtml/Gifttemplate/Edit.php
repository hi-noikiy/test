        ...
        $this->_formScripts[] = "
            ...
            function changePattern(){
                ...
                if(template_id == ".Magestore_Giftvoucher_Model_Designpattern::PATTERN_CENTER.")
				{
					...
					$('note_style_color').down('span').innerHTML = '".Mage::helper('giftvoucher')->__('Choose color of texts in Gift Card title, value and gift code fields. (Recommended color: #FFFFFF)')."';
				...
				{					
					...
					if (template_id == ".Magestore_Giftvoucher_Model_Designpattern::PATTERN_LEFT."){
						...
						$('note_style_color').down('span').innerHTML = '".Mage::helper('giftvoucher')->__('Choose color of texts in Gift Card title, value and gift code fields. (Recommended color: #DC8C71)')."';
                    ...
                    if (template_id == ".Magestore_Giftvoucher_Model_Designpattern::PATTERN_SIMPLE." || template_id == ".Magestore_Giftvoucher_Model_Designpattern::PATTERN_AMAZON."){
