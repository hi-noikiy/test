...
class Magestore_Giftvoucher_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function testAction()
    {
        ...
        Mage::helper('giftvoucher/pdf')->printPdf('giftvoucher/print', 'giftvoucher/test.phtml', $data);
    }
    ...
    public function test1Action()
    {
        ...
        $html = Mage::helper('giftvoucher/pdf')->getHtml('giftvoucher/print', 'giftvoucher/test.phtml', $data);
