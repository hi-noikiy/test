...
//            hiepdd end
            ...
            $html_addrewardpoints = $block->getLayout()->createBlock('rewardpoints/checkout_onepage_payment_rewrite_methods')
            ->setTemplate('rewardpoints/checkout/payment/onestep.phtml')->renderView();
