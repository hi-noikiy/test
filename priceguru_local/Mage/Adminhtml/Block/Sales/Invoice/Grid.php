...
class Mage_Adminhtml_Block_Sales_Invoice_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->join('sales_flat_order', 'main_table.order_id = sales_flat_order.entity_id', array('iscimorder', 'customer_firstname','status'));
        $collection->getSelect()->join('sales_flat_order_payment','main_table.order_id=parent_id', array('method'));
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('username', array(
            'header'    => Mage::helper('sales')->__('User Name'),
            'index'     => 'username',
        ));
        ...
        $this->addColumn('method', array(
            ...
            'renderer' => 'adminhtml/sales_invoice_renderer_paymentmethod',
            'options'   => array(
              'cashondelivery' => 'Pay on Delivery',
              'banktransfer' => 'Internet Banking',
              'migs_hosted' => 'Credit Card',
            ),    
        ));
