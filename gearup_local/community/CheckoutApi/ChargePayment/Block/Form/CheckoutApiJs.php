...
class CheckoutApi_ChargePayment_Block_Form_CheckoutApiJs  extends Mage_Payment_Block_Form_Cc
{
    ...
    public function getPublicKey() {
        ...
        if(Mage::getModel('chargepayment/creditCardJs')->getCurrencyCode() == 'AED'){ 
            $publicKey = Mage::helper('chargepayment')->getConfigData($this->_paymentCode, 'publickeyAed');
        } else {
            $publicKey = Mage::helper('chargepayment')->getConfigData($this->_paymentCode, 'publickeyOther');
        }
