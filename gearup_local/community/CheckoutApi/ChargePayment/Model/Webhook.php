...
class CheckoutApi_ChargePayment_Model_Webhook
{
    ...
    */
    ...
    public function authorizeByPaymentToken($responseToken) {
        ...
        if(Mage::app()->getStore()->getCurrentCurrencyCode() == 'AED'){
            $secretKey = Mage::helper('chargepayment')->getConfigData('checkoutapijs', 'secretkeyAed');
        } else {
            $secretKey = Mage::helper('chargepayment')->getConfigData('checkoutapijs', 'secretkeyOther');
        }
