    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        foreach ($fields as $key => $value) {
            $comment = ($key == 'plumbase_account_email') ? '<p class="note">
                <span>' .  Mage::helper('plumbase')->__('You can find Marketplace Order ID and Email in your Magento Marketplace Account. For manual <a target="_blank" href="%s">click here</a>.', 'http://wiki.plumrocket.com/License_Installation_For_Magento_1_Marketplace_Customers')
                . '</span></p>' : '';
