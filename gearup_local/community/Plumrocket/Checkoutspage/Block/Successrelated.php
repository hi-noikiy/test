...
class Plumrocket_Checkoutspage_Block_Successrelated extends Mage_Catalog_Block_Product_Abstract
{
            ...
            if (is_null($this->_itemCollection)) {
            	...
            	if ($this->showRecentlyViewedProducts()) {
	                ...
	                $collection = $this->_getCollection()
	                    ->addProductFilter( $this->_getAllProductIds($this->getOrder()));
    ...
    {
        $method = 'use'.ucfirst($this->getLinksType()).'Links';
