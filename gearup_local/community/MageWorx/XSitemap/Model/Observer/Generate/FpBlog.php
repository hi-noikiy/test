...
class MageWorx_XSitemap_Model_Observer_Generate_FpBlog
{
    public function addGenerator($observer)
    {
        ...
        if ($helper->isBlogGenerateEnabled() && $helper->isModuleOutputEnabled('Fishpig_Wordpress')) {
            ...
            $generators[$generatorName][$titleKey] = $helper->__('Generated Fishpig Wordpress Blog');
            $generators[$generatorName][$modelKey] = 'mageworx_xsitemap/generator_fpBlog';
