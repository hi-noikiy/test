...
class MageWorx_SeoCrossLinks_Adminhtml_Mageworx_Seocrosslinks_CrosslinkController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        if (!empty($data['ref_product_sku']) && !$productModel->getIdBySku($data['ref_product_sku'])){
            $message = $helper->__('The target product (SKU \'% s\') is not found.', $data['ref_product_sku']);
    ...
    protected  function _prepareData()
    {
        ...
        $saveSku = $this->getRequest()->getParam('ref_product_sku');
        $data = $helperFunction->arrayMapRecursive('trim', $this->getRequest()->getPost());
        $data['ref_product_sku'] = $saveSku;
        return $data;
    }
    ...
    {
        $this->_massInitAction('in_category');
        $this->_redirect('*/*/index');
    }
    ...
    public function massChangeNofollowAction()
    {
        $this->_massInitAction('nofollow_rel');
        $this->_redirect('*/*/index');
    }
