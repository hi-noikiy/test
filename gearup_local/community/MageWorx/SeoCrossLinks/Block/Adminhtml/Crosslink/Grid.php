...
class MageWorx_SeoCrossLinks_Block_Adminhtml_Crosslink_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'nofollow_rel',
            array(
                'header'  => Mage::helper('catalog')->__('Nofollow'),
                'align'   => 'right',
                'width'   => '75px',
                'index'   => 'nofollow_rel',
                'type'    => 'options',
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            'nofollow_rel',
            array(
                'label'      => Mage::helper('mageworx_seocrosslinks')->__("Change 'Nofollow'"),
                'url'        => $this->getUrl('*/*/massChangeNofollow', array('_current' => true, 'store' => $this->getStoreId())),
                'additional' => array(
                    'visibility' => array(
                        'name'     => 'nofollow_rel',
                        'type'     => 'select',
