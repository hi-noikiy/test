...
class MageWorx_SeoCrossLinks_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    /**
     * XML config path default nofollow
     */
    const XML_PATH_DEFAULT_NOFOLLOW               = 'mageworx_seo/seocrosslinks/default_nofollow';
    ...
    /**
     * Retrive default nofollow
     *
     * @return int
     */
    public function getDefaultNofollow()
    {
        return (int)Mage::getStoreConfigFlag(self::XML_PATH_DEFAULT_NOFOLLOW);
    }
