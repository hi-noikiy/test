...
abstract class MageWorx_SeoBase_Model_Hreflang_Abstract extends Mage_Core_Model_Abstract
{
    ...
    /**
     * @var MageWorx_SeoBase_Helper_Hreflang
     */
    protected $_helperHreflang;
    ...
    {
        $this->_helperHreflang = Mage::helper('mageworx_seobase/hreflang');
        $this->_storeId = Mage::app()->getStore()->getStoreId();

        if (!$this->_helperHreflang->isAlternateTagsEnabled($this->_entityType, $this->_storeId)) {
            return null;
        }
