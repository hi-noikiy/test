...
class Justselling_Assetminify_Model_Selftester_Db extends Mage_Core_Model_Abstract {
    public $messages = array();
    public $errorOccurred = false;
    protected $_dbOkay = true;

    public function dbCheck (Justselling_Assetminify_Model_Selftester $selftester) {
        $localError = false;
    ...
    protected function _dbCheckEav(Justselling_Assetminify_Model_Selftester $selftester, $field, $installer, $localError) {
        try {
    ...
    protected function _dbCheckSqlColumn(Justselling_Assetminify_Model_Selftester $selftester, $field, $installer, $localError) {
        try {
