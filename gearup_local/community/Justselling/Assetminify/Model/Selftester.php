...
class Justselling_Assetminify_Model_Selftester extends Justselling_Assetminify_Model_SelftesterCommon {
    ...
    public function _getVersions() {
        parent::_getVersions();
        $this->messages[] = 'Justselling Assetminify version: ' .
            (string)Mage::getConfig()->getModuleConfig('Justselling_Assetminify')->version;
    }

    public function _getRewrites() {
        return array(
            array("block", "page/html_head", "Justselling_Assetminify_Block_Page_Html_Head"),
            array("block", "adminhtml/page_head", "Justselling_Assetminify_Block_Adminhtml_Page_Head"),
        );
    }

    public function _getFiles() {
        return array(
            'skin/assetminify/.htaccess',
            'app/code/community/Justselling/Assetminify/sql/assetminify_setup/mysql4-install-0.1.0.php',
            'app/code/community/Justselling/Assetminify/Block/Adminhtml/Extensioninfo.php',
            'app/code/community/Justselling/Assetminify/Block/Adminhtml/Page/Head.php',
            'app/code/community/Justselling/Assetminify/Block/Page/Html/Head.php',
            'app/code/community/Justselling/Assetminify/etc/adminhtml.xml',
            'app/code/community/Justselling/Assetminify/etc/config.xml',
            'app/code/community/Justselling/Assetminify/etc/system.xml',
            'app/code/community/Justselling/Assetminify/Helper/Data.php',
            'app/code/community/Justselling/Assetminify/Model/Check.php',
            'app/code/community/Justselling/Assetminify/Model/BuildSpeedster.php',
            'app/code/community/Justselling/Assetminify/Model/Selftester.php',
            'app/etc/modules/Justselling_Assetminify.xml',
            'lib/minify/m.php',
    ...
    protected function _checkModuleOutput() {
        ...
        try {
            ...
            foreach ($allStores as $storeId => $val) {
                if (Mage::getStoreConfigFlag('advanced/modules_disable_output/Justselling_Assetminify', $storeId)) {
                    $this->messages[] = '"' . Mage::app()->getStore($storeId)->getName() .
                        '" store has output disabled for Assetminify module (Step 1)';
    ...
    protected function _verifyURLRewriting() {
        ...
        try {
            ...
            $moduleVersion = (string)Mage::getConfig()->getNode()->modules->Justselling_Assetminify->version;

            if (version_compare($moduleVersion, '2.0.0', '>=')) {
                $url = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_WEB) .
                    'skin/assetminify/1232681243/skin/frontend/default/default/css/print.css';
            }
        ...
        if (Mage::getStoreConfigFlag('assetminify/settings/enabled')) {
            ...
            try {
                ...
                foreach ($cssLinks[1] as $cssLink) {
                    if (strpos($cssLink, '/assetminify/') === false) {
                        $this->messages[]
                            = 'Verify Full Assetmnify Process ERROR: "' . $cssLink . '" doesn\'t contain ' .
