...
class Payfort_Pay_Model_Observer extends Mage_CatalogInventory_Model_Observer
{
    ...
    public function paymentMethodIsActive($observer)
    {
        ...
        $installmentCode  = Mage::getModel('payfort/payment_installments')->getCode();       
        ...
        if ($method->getCode() == $installmentCode) {

            $shipping = $observer->getEvent()->getQuote()->getShippingAddress();
            $store = Mage::app()->getStore()->getStoreId();
            $specificCountry = explode(',', Mage::getStoreConfig('payment/' . $installmentCode . '/specificcountry', $store));
