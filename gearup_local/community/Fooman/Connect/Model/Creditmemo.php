        ...
        if (0 == $creditmemo->getBaseGrandTotal()) {
            ...
            try {
                ...
                if (Mage::getStoreConfigFlag('foomanconnect/creditmemo/cashrefund', $creditmemo->getStoreId())) {
                    ...
                    } elseif (strpos($creditmemo->getOrder()->getPayment()->getMethod(), 'payfortinstallments') !== false) {
                        $data['account_id'] = Mage::getStoreConfig(
                            'foomanconnect/creditmemo/payfortrefundbankaccount', $creditmemo->getStoreId()
                        );
                    } else {
                        $data['account_id'] = Mage::getStoreConfig(
