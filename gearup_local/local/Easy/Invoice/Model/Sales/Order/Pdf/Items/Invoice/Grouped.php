 ...
 */
class Easy_Invoice_Model_Sales_Order_Pdf_Items_Invoice_Grouped extends Easy_Invoice_Model_Sales_Order_Pdf_Items_Invoice_Default
{
    public function draw()
    {
        $type = $this->getItem()->getOrderItem()->getRealProductType();
        $renderer = $this->getRenderedModel()->getRenderer($type);
        $renderer->setStore($this->getStore());
