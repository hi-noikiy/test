...
class Biztech_Trackorder_Model_Observer {
    ...
    public function checkOrdertrack($observer) {
        $formId = 'track_order_captcha';
        ...
        if ($captchaModel->isRequired()) {
            ...
            if (!$captchaModel->isCorrect($word)) {
                ...
                $controller->getResponse()->setBody($controller->getLayout()->getMessagesBlock()->getGroupedHtml());
    ...
    /*
     * Redirect Customer to home page while access Guest form
     */
    public function redirectGuestForm($observer) {
