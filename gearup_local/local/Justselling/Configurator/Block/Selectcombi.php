...
class Justselling_Configurator_Block_Selectcombi extends Justselling_Configurator_Block_Default
{	
    ...
    public function getCombinedElements()
    {
        ...
        $elements[] = array('id' => $this->getTemplateOption()->getId(), 'type'=>'selectcombi');
        return $elements;
    }
	...
	public function getJavascript() {
        ...
        if( $this->templateOption->hasPricelist() ) {
            ...
            $priceCallback = "function(self) { return Configuration.combinationPriceFromPricelistCallback(self, '".$pricelist."', ".$decimal_place.", 'selectcombi'); }";
        } else {
	        ...
	        $priceCallback = "function(self) { return Configuration.combinationPriceCallback(self,'".$pricelist."', '".$operator."', ".$decimal_place.",'selectcombi'); }";
        }
