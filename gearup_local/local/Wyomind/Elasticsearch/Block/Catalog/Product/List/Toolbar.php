...
} elseif (Mage::helper("core")->isModuleEnabled("Amasty_Sorting") && class_exists("Wyomind_Elasticsearch_Block_Catalog_Product_List_Toolbar_Amasty_Pure")) {
    //Amasty_Sorting before Amasty_Shopby because Sorting already handles the Shopby inheritence if needed.
    class Wyomind_Elasticsearch_Block_Catalog_Product_List_Toolbar_Abstract extends Wyomind_Elasticsearch_Block_Catalog_Product_List_Toolbar_Amasty_Pure
    {
