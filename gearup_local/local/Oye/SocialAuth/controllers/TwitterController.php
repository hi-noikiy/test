<?php
class Oye_SocialAuth_TwitterController extends Mage_Core_Controller_Front_Action
{
    protected $referer = null;

    public function requestAction()
    {
        $client = Mage::getSingleton('oye_socialauth/twitter_client');
        if(!($client->isEnabled())) {
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        $this->referer = Mage::getUrl('socialauth/account/twitter');  
        
        Mage::helper('oye_socialauth/twitter')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        $customersByTwitterId = Mage::helper('oye_socialauth/twitter')
        ...
        if(Mage::getSingleton('customer/session')->isLoggedIn()) {
            ...
            Mage::helper('oye_socialauth/twitter')->connectByTwitterId(
                $customer,
                $userInfo->id,
                $token
            );
        ...
        if($customersByTwitterId->count()) {
            ...
            Mage::helper('oye_socialauth/twitter')->loginByCustomer($customer);
        ...
        $customersByEmail = Mage::helper('oye_socialauth/twitter')
        ...
        Mage::helper('oye_socialauth/twitter')->connectByCreatingAccount(
            $userInfo->email,
            $userInfo->name,
            $userInfo->id,
            $token
