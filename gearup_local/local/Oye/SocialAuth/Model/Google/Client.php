<?php
class Oye_SocialAuth_Model_Google_Client
{
    const REDIRECT_URI_ROUTE = 'socialauth/google/connect';

    const XML_PATH_ENABLED = 'socialauth/oye_socialauth_google/enabled';
    const XML_PATH_CLIENT_ID = 'socialauth/oye_socialauth_google/client_id';
    const XML_PATH_CLIENT_SECRET = 'socialauth/oye_socialauth_google/client_secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new Oye_SocialAuth_GoogleOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('oye_socialauth')
...
class Oye_SocialAuth_GoogleOAuthException extends Exception
{}
