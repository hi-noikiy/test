 ...
 * @package Amasty_Feed
 */ 
class Gearup_Amastyfeed_Block_Adminhtml_Content extends Amasty_Feed_Block_Adminhtml_Profile_Edit_Tab_Content
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('amasty/amfeed/feed/content2.phtml');
    ...
    public function getAttributes()
    {
        ...
        return array(
            'product' => array(
                'label'   => $hlr->__("Product Attributes123"),
