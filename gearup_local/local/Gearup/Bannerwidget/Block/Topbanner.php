<?php
class Gearup_Bannerwidget_Block_Topbanner extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface
{
    /**
     * Widget Parameters
     * 
    ...
    {
        parent::_construct();
        $this->setTemplate('bannerwidget/homebanner.phtml');
    }
    ...
    protected function getResourceModel()
    {
        ...
        $widgetId = Mage::getStoreConfig('bannerwidget/general/widgetid', $storeId);
