...
class Gearup_Configurator_Helper_Tax extends Mage_Tax_Helper_Data {
    ...
    public function getPrice($product, $price, $includingTax = null, $shippingAddress = null, $billingAddress = null, $ctc = null, $store = null, $priceIncludesTax = null, $roundPrice = true) {
        ...
        $_configuratorHelper = Mage::helper('configurator');     echo "dsdsadsdsad<br/>";          
...
//            echo $price;
//            echo "<br/>";
//            echo $configuratorPrice;;

            return $store->roundPrice($price+$configuratorPrice);
        }
