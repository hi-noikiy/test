 ...
 * Rounding Helper
 */
class Mish_Rounding_Block_Catalog_Product_View_Bundle extends Mage_Bundle_Block_Catalog_Product_View_Type_Bundle {
    ...
    public function getJsonConfig() {
        ...
        foreach ($optionsArray as $_option) {
            ...
            foreach ($_option->getSelections() as $_selection) {
                ...
                $_taxOnPrice =  Mage::getSingleton('tax/calculation')->calcTaxAmount($itemPrice, $_selection->getTaxPercent(), false, true,true);
                ...
                $selection = array(
                    ...
                    'priceInclTax' => $coreHelper->currency($_priceExclTax, false, false) + $coreHelper->currency($_taxOnPrice, false, false),
