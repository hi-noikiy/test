...
class Mish_Catalog_Model_Catalog_Url extends Mish_Catalog_Model_Catalog_Url_Amasty_Pure
{
    /**
     * Fix for duplicating records when reindexing
     *
    ...
    public function getProductRequestPath($product, $category)
    {
        ...
        if (false === $validatedPath && isset($this->_rewrites[$idPath])) {
            $existingRequestPath = $this->_rewrites[$idPath]->getRequestPath();
