                ...
                foreach ($bundleOptions as $bundleOption) {
                    if ($bundleOption->getSelections()) {
                        ...
                        foreach ($bundleSelections as $bundleSelection) {
                            ...
                            if ($qty) {
                                $_store = $bundleSelection->getStore();
                                $_convertedFinalPrice = $_store->roundPrice($_store->convertPrice($bundleSelection->getFinalPrice()));
                                $_finalPriceInclTax = Mage::helper('tax')->getPrice($bundleSelection, $_convertedFinalPrice, true);
