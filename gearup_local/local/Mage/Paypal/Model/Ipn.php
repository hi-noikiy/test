...
class Mage_Paypal_Model_Ipn
{
    ...
    protected function _postBack(Zend_Http_Client_Adapter_Interface $httpAdapter)
    {
        ...
        $httpAdapter->write(
            ...
            $postbackUrl,
            '1.1',
            array('Connection: close', 'User-Agent: gear-up.me'),
            $postbackQuery
        );
        ...
        //file_put_contents('var/log/paypal_postback_ipn.log', date("Y-m-d H:i:s") . PHP_EOL . $postbackResult . PHP_EOL, FILE_APPEND);
