...
class Mage_Catalog_Model_Layer_Filter_Category extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    ...
    public function getCategory()
    {
        ...
        if (!Mage::app()->getRequest()->getParam('cat') && $category->getData('show_category_filter')) {
            return Mage::getModel('catalog/category')->load(Gearup_Sds_Helper_Data::ROOT_CAT_ID);
        }
