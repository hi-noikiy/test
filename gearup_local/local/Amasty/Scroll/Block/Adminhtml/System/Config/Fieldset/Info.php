...
class Amasty_Scroll_Block_Adminhtml_System_Config_Fieldset_Info
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    protected $_contentHtml = '';

    protected $_moduleCode = 'Amasty_Scroll';

    protected $_userGuideLink = 'https://amasty.com/media/user_guides/ajax_scroll_user_guide.pdf';
