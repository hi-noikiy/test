...
class Amasty_Optimization_Block_Adminhtml_System_Config_Fieldset_Info
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    protected $_contentHtml = '';

    protected $_moduleCode = 'Amasty_Optimization';

    protected $_userGuideLink = 'https://amasty.com/docs/doku.php?id=magento_1:google_page_speed_optimizer';
