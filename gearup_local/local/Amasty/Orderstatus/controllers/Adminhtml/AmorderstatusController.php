 ...
 */
class Amasty_Orderstatus_Adminhtml_AmorderstatusController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('sales/amorderstatus');
    }
}