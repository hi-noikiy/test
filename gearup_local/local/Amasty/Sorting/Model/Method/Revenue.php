...
class Amasty_Sorting_Model_Method_Revenue extends Amasty_Sorting_Model_Method_Abstract
{
    ...
    public function getColumnSelect()
    {
        ...
        $exclude = Mage::getStoreConfig('amsorting/bestsellers/exclude');
        if ($exclude) {
        ...
        $sql .= $this->getPeriodCondition('order_item.created_at', 'general/best_revenue_period');
    ...
    {
        $attr = Mage::getStoreConfig('amsorting/bestsellers/best_attr');
        if ($attr) {
