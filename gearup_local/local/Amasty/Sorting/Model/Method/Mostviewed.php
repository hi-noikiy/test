...
class Amasty_Sorting_Model_Method_Mostviewed extends Amasty_Sorting_Model_Method_Abstract
{
    ...
    public function getColumnSelect()
    {
        ...
        if (version_compare(Mage::getVersion(), '1.4') >= 0) { 
            $sql =' SELECT COUNT(*)'
                ...
                . $this->getPeriodCondition('viewed_item.logged_at', 'most_viewed/viewed_period')
            ...
            $sql =' SELECT COUNT(*)'
                ...
                . $this->getPeriodCondition('viewed_item.added_at', 'most_viewed/viewed_period')
            ;
        }
    ...
    {
        $attr = Mage::getStoreConfig('amsorting/most_viewed/viewed_attr');
        if ($attr) {
