...
class AW_Advancedreports_Block_Advanced_Salesoverview_Grid extends AW_Advancedreports_Block_Advanced_Grid
{
    ...
    const GRID_ID_ADVANCED_SALESOVERVIEW = 'gridSalesoverview';

    public function __construct()
    {
        parent::__construct();
        $this->setId(self::GRID_ID_ADVANCED_SALESOVERVIEW);
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'points_credit',
            array(
                'header'        => Mage::helper('reports')->__('Points and credit applied'),
                'type'          => 'currency',
                'currency_code' => $currencyCode,
                'index'         => 'points_credit',
                'total'         => 'sum',
