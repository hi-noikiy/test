...
class AW_Advancedreports_Block_Advanced_Ordersdetailed_Grid extends AW_Advancedreports_Block_Advanced_Grid
{
    ...
    const GRID_ID_ADVANCED_ORDERSDETAILED = 'gridOrdersdetailed';

    public function __construct()
    {
        parent::__construct();
        $this->setFilterVisibility(true);
        $this->setId(self::GRID_ID_ADVANCED_ORDERSDETAILED);
...
/*
        ...
        $this->addColumn(
            'base_xpoints_credit',
            array(
                'header'           => $this->__('Points and credit applied'),
                'width'            => '80px',
                'type'             => 'currency',
                'currency_code'    => $this->getCurrentCurrencyCode(),
                'renderer'         => 'advancedreports/widget_grid_column_renderer_percent',
                'total'            => 'sum',
                'index'            => 'base_xpoints_credit',
                'column_css_class' => 'nowrap',
                'default'          => $defValue,
            )
        );
