...
{
    /**
     * Columns IDs for profit columns
     */
    const TOTAL_COST_COLUMN_ID = 'total_cost';
    const TOTAL_REVENUE_EXCL_TAX_COLUMN_ID = 'total_revenue_excl_tax';
    const TOTAL_REVENUE_COLUMN_ID = 'total_revenue';
    const TOTAL_PROFIT_COLUMN_ID = 'total_profit';
    const TOTAL_MARGIN_COLUMN_ID = 'total_margin';
    ...
    public function addProfitColumns()
    {
        ...
        $this->addColumn(
            self::TOTAL_REVENUE_EXCL_TAX_COLUMN_ID,
            array(
    ...
    protected function _isNeedToAddProfitInfo()
    {
        $columns = $this->getColumns();
        return $this->_isAtLeastOneProfitColumnVisible($columns);
    }

    protected function _isAtLeastOneProfitColumnVisible($columns)
    {
        $flag = false;
        $profitColumnsIds = $this->_getProfitColumnsIds();
        foreach ($columns as $column) {
            $columnId = $column->getId();
            if ($flag = in_array($columnId, $profitColumnsIds)) {
                break;
            }
        }
        return $flag;
     ...
     * @return array
     */
    protected function _getProfitColumnsIds()
    {
        return array(
            self::TOTAL_COST_COLUMN_ID,
            self::TOTAL_REVENUE_EXCL_TAX_COLUMN_ID,
