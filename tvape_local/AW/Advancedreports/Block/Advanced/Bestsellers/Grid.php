...
class AW_Advancedreports_Block_Advanced_Bestsellers_Grid extends AW_Advancedreports_Block_Advanced_Grid
{
    ...
    const GRID_ID_ADVANCED_BESTSELLERS = 'gridBestsellers';
    ...
    public function __construct()
    {
        ...
        $this->setId(self::GRID_ID_ADVANCED_BESTSELLERS);
    ...
    public function getCustomOptionsRequired()
    {
        ...
        $addArray = array(
            ...
            array(
                ...
                'default' => AW_Advancedreports_Model_System_Config_Source_Skutype::SKUTYPE_CHILD,
            ),
        );
