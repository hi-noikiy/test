...
class AW_Advancedreports_Block_Dashboard extends Mage_Adminhtml_Block_Template
{
    ...
    protected function _createChart($type, $option, $width, $route, $elementId)
    {
        $script = "
            <script type='text/javascript'>
                insertChart(
                        ...
                        '{$option}',
                        '{$width}',
                        '{$this->getDefaultChartHeight()}',
                        '{$this->getDefaultChartBackgroundColor()}'
                 );
            </script>
        ";
    ...
    public function getAverageOrderValueChart()
    {
        ...
        $chartType = AW_Advancedreports_Block_Chart::CHART_TYPE_LINE;

        $chart = $this->_createChart(
            $chartType,
            $chartParams[0]['value'],
            null,
            AW_Advancedreports_Helper_Data::ROUTE_ADVANCED_SALESSTATISTICS,
            $this->getAverageOrderValueChartId()
        );
        return $chart;
    }
    ...
    public function getNewSignupChart()
    {
        ...
        $chart = $this->_createChart(
            AW_Advancedreports_Block_Chart::CHART_TYPE_LINE,
            'accounts',
            null,
            $route,
            $this->getNewSignupChartId()
        );
        return $chart;
    }
    ...
    public function getSalesOverviewChartId()
    {
        return "dashboard_chart_sales_overview";
    }

    public function getAverageOrderValueChartId()
    {
        return "dashboard_chart_average_order_value";
    }

    public function getItemsPerOrderChartId()
    {
        return "dashboard_chart_items_per_order";
    }

    public function getNewSignupChartId()
    {
        return "dashboard_chart_new_signup";
    }

    public function getDefaultChartHeight()
    {
        return 300;
    }

    public function getDefaultChartBackgroundColor()
    {
        return 'f9f9f9';
    }
}