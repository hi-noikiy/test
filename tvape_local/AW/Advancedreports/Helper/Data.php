...
class AW_Advancedreports_Helper_Data extends AW_Advancedreports_Helper_Abstract
{
    ...
    public function isNeedToIncludeTaxesInProfit()
    {
        if (($flag = $this->getSetup()->getCustomConfig('advancedreports/configuration/include_taxes_in_profit')) !== null) {
            return $flag;
        }
        return Mage::getStoreConfig('advancedreports/configuration/include_taxes_in_profit');
    }
    ...
    public function getChartParams($key)
    {
        ...
        $params[self::ROUTE_SALES_SALESOVERVIEW] = array(
            ...
            array('value' => 'total_profit', 'label' => 'Total Profit'),
            array('value' => 'total_margin', 'label' => 'Total Margin'),
        );
    ...
    public function setDetailOption($data)
    {
        $session = Mage::getSingleton('core/session', array('name' => 'backend'))->start();
        $session->setAwDetailOption($data);
        return $this;
    }
    ...
    {
        $session = Mage::getSingleton('core/session', array('name' => 'backend'))->start();
        return $session->getAwDetailOption();
    }
    ...
    */
    ...
    public function isAwStorecreditInstalled()
    {
        return $this->isModuleEnabled("AW_Storecredit");
    }

    public function isAwPointsInstalled()
    {
        return $this->isModuleEnabled("AW_Points");
    }

    public function getGridIdsForReportsWithProfits()
    {
        $gridIds = array(
            AW_Advancedreports_Block_Advanced_Ordersdetailed_Grid::GRID_ID_ADVANCED_ORDERSDETAILED,
            AW_Advancedreports_Block_Advanced_Bestsellers_Grid::GRID_ID_ADVANCED_BESTSELLERS,
            AW_Advancedreports_Block_Advanced_Product_Grid::GRID_ID_ADVANCED_PRODUCT,
            AW_Advancedreports_Block_Advanced_Salesdetailed_Grid::GRID_ID_ADVANCED_SALESDETAILED,
            AW_Advancedreports_Block_Advanced_Salesoverview_Grid::GRID_ID_ADVANCED_SALESOVERVIEW
        );
        if (@class_exists("AW_Advancedreports_Block_Additional_Salesbycategory_Grid")) {
            $gridIds[] = AW_Advancedreports_Block_Additional_Salesbycategory_Grid::GRID_ID_ADDITIONAL_SALESBYCATEGORY;
        }
        return $gridIds;
    }
}