 ...
 */
class Webkul_Eshopsync_Block_Adminhtml_Contactus_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('eshopsync_data') && Mage::registry('eshopsync_data')->getId()) {
            return Mage::helper('eshopsync')->__("%s", $this->htmlEscape(Mage::registry('eshopsync_data')->getName()));
        } else {
