 ...
 */
class Webkul_Eshopsync_Block_Adminhtml_Product_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('magento_id', 'select', array(
          'label'     => Mage::helper('eshopsync')->__('Magento product'),
      ...
      $fieldset->addField('sforce_id', 'select', array(
          'label'     => Mage::helper('eshopsync')->__('Salesforce product'),
          'class'     => 'required-entry',
          'name'    =>'sforce_id',
          // 'values'    => $Erp_cat
      ));
