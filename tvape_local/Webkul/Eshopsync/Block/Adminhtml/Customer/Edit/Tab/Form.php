 ...
 */
class Webkul_Eshopsync_Block_Adminhtml_Customer_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldset->addField('sforce_id', 'select', array(
          'label'     => Mage::helper('eshopsync')->__('Salesforce Account'),
          'class'     => 'required-entry',
          'name'    =>'sforce_id',
          // 'values'    => $Erp_cat
      ));
