 ...
 */ 
class Webkul_Eshopsync_Block_Adminhtml_Customer_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          ...
          'content'   => $this->getLayout()->createBlock('eshopsync/adminhtml_customer_edit_tab_form')->toHtml(),
      ));
