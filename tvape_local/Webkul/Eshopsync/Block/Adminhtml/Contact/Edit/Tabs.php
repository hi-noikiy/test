 ...
 */
class Webkul_Eshopsync_Block_Adminhtml_Contact_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          ...
          'content'   => $this->getLayout()->createBlock('eshopsync/adminhtml_contact_edit_tab_form')->toHtml(),
      ));
