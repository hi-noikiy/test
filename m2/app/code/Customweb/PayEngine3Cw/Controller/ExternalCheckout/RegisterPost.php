...
namespace Customweb\PayEngine3Cw\Controller\ExternalCheckout;

class RegisterPost extends \Customweb\PayEngine3Cw\Controller\ExternalCheckout
{
	/**
	...
	{
		if (!($this->getContext() instanceof \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context) || !$this->getContext()->getId()) {
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\PayEngine3Cw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER);
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER))) {
