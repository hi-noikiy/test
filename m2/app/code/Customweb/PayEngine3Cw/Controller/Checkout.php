...
namespace Customweb\PayEngine3Cw\Controller;
...
abstract class Checkout extends \Magento\Framework\App\Action\Action
{
	 ...
	 */
	protected function handleSuccess(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 */
	protected function handleFailure(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction, $errorMessage)
	{
		$this->_checkoutSession->setLastRealOrderId($transaction->getOrder()->getRealOrderId());
		$this->restoreQuote();

		$this->messageManager->addErrorMessage($errorMessage);
// 		$this->_checkoutSession->setPayEngine3CwFailureMessage($errorMessage);
