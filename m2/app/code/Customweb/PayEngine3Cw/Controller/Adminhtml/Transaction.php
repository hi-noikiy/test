...
namespace Customweb\PayEngine3Cw\Controller\Adminhtml;
...
abstract class Transaction extends \Magento\Backend\App\Action
{
	...
	protected function _initAction()
	{
		...
		$resultPage->setActiveMenu('Customweb_PayEngine3Cw::transactions');
		$resultPage->addBreadcrumb(__('Sales'), __('Sales'));
		$resultPage->addBreadcrumb('Concardis PayEngine 3.0', 'Concardis PayEngine 3.0');
		$resultPage->addBreadcrumb(__('Concardis PayEngine 3.0 Transactions'), __('Concardis PayEngine 3.0 Transactions'));
		return $resultPage;
	}
	 ...
	 *
	 * @return \Customweb\PayEngine3Cw\Model\Authorization\Transaction|false
	 */
	protected function _initTransaction()
	{
		...
		$this->_coreRegistry->register('payengine3cw_transaction', $transaction);
		return $transaction;
	}

	protected function _isAllowed()
	{
		return $this->_authorization->isAllowed('Customweb_PayEngine3Cw::transactions');
	}
}