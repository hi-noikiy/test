...
namespace Customweb\PayEngine3Cw\Controller\Adminhtml\Config;

class Save extends \Customweb\PayEngine3Cw\Controller\Adminhtml\Config
{
	...
	private function storeConfigState()
	{
		...
		$storedConfigState = $storage->read(\Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY);
		...
		$storage->write(\Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY, $updatedConfigState);
	}
