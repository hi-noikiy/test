...
class Widget extends \Customweb\PayEngine3Cw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\PayEngine3Cw\Model\Authorization\Method\Widget */
		...
		$resultPage->getLayout()
			->getBlock('customweb_payengine3cwcheckout_widget')
