...
namespace Customweb\PayEngine3Cw\Model\Alias;
...
class Handler
{
	 ...
	 */
	public function getAliasTransactions(\Customweb\PayEngine3Cw\Model\Authorization\OrderContext $orderContext)
	{
	 ...
	 */
	public function removeSimilarAliases(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function removeAlias(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws Exception
	 */
	public function deactivateAlias(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction)
	{
		$transaction->setAliasActive(false);
		$transaction->save();
	}
