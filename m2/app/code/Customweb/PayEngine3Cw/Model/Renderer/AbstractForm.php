...
namespace Customweb\PayEngine3Cw\Model\Renderer;
...
class AbstractForm extends \Customweb_Form_Renderer
{
	...
	protected function renderRegisterCallback($jsFunctionPostfix){
		...
		$registerJs = "require(['jquery', 'domReady', 'Customweb_PayEngine3Cw/js/form'], function($, domReady, Form){\n";
	...
	{
		$eventJs = "require(['jquery', 'domReady', 'Customweb_PayEngine3Cw/js/form', 'mage/template'], function($, domReady, Form, mageTemplate){\n";
