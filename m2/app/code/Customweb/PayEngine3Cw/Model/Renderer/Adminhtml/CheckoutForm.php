...
namespace Customweb\PayEngine3Cw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\PayEngine3Cw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('payengine3cw_form');
