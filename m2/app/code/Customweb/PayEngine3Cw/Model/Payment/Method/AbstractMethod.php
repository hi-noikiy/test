 ...
 *
 */
namespace Customweb\PayEngine3Cw\Model\Payment\Method;
...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	...
	/**
	 *
	 * @var \Customweb\PayEngine3Cw\Model\Configuration
	 */
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\PayEngine3Cw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\PayEngine3Cw\Block\Payment\Method\Info';
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\Configuration $configuration
	...
	public function __construct(
			...
			\Customweb\PayEngine3Cw\Model\Configuration $configuration,
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		$transactionId = null;
		$transaction = $this->_registry->registry('payengine3cw_transaction');
		if ($transaction instanceof \Customweb\PayEngine3Cw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('payengine3cw/checkout/error', [
			'_secure' => true,
	...
	public function validate()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_PayEngine3Cw_License::run('ga6rur2sfqagmee5', $this, $arguments);
	}

	final public function call_jjum5k07high467o() {
	 ...
	 * @return \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		$transaction = $this->_registry->registry('payengine3cw_authorization_transaction');
		if ($transaction instanceof \Customweb\PayEngine3Cw\Model\Authorization\Transaction) {
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		try {
			...
			if ($transaction->getId()) {
				$invoice = $this->_registry->registry('payengine3cw_invoice');
	...
	private function captureItems(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction, $items = [])
	{
