...
class LayoutRenderer extends \Customweb_Mvc_Layout_Renderer
{
	...
	{
		$this->_view->loadLayout(['default', 'payengine3cw_layout_renderer'], true, true, false);
		...
		$this->_view->getPage()->getConfig()->addPageAsset('Customweb_PayEngine3Cw::css/payengine3cw.css');
	}
	...
	{
		$this->_view->getLayout()->addBlock('\Magento\Framework\View\Element\Text', 'payengine3cw.main.content', 'content')->setText($content);
	}
