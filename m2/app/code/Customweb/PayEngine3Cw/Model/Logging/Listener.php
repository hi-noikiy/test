...
namespace Customweb\PayEngine3Cw\Model\Logging;
...
class Listener implements \Customweb_Core_Logger_IListener {
	 ...
	 * @var string
	 */
	protected $fileName = '/var/log/payengine3cw.log';
	...
	public function __construct(
		...
		$this->_logger = new Logger('payengine3cw');
	...
	private function isLevelActive($level) {
		switch ($this->_scopeConfig->getValue('payengine3cw/logging/level')) {
			case 'debug':
				return true;
			case 'info':
