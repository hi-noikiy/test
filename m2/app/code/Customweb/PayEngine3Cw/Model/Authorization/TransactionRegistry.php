...
class TransactionRegistry
{
	...
	public function retrieve($transactionId)
	{
		...
		if ($transaction->getId() === null || $transaction->getId() != $transactionId) {
			throw \Magento\Framework\Exception\NoSuchEntityException::singleField(\Customweb\PayEngine3Cw\Api\Data\TransactionInterface::ENTITY_ID, $transactionId);
		}
	...
	public function retrieveByPaymentId($paymentId)
	{
		...
		if ($transaction->getId() === null || $transaction->getPaymentId() != $paymentId) {
			throw \Magento\Framework\Exception\NoSuchEntityException::singleField(\Customweb\PayEngine3Cw\Api\Data\TransactionInterface::ENTITY_ID, $paymentId);
		}
	...
	public function retrieveByOrderId($orderId)
	{
		...
		if ($transaction->getId() === null || $transaction->getOrderId() != $orderId) {
			throw \Magento\Framework\Exception\NoSuchEntityException::singleField(\Customweb\PayEngine3Cw\Api\Data\TransactionInterface::ENTITY_ID, $orderId);
		}
