...
namespace Customweb\PayEngine3Cw\Model\Authorization;

use \Customweb\PayEngine3Cw\Api\Data\TransactionInterface;
use Magento\Customer\Model\Customer;

/**
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setSendEmail(boolean $value)
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\PayEngine3Cw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_payengine3cw_transaction';
	 ...
	 * @var string
	 */
	protected $_entityType = 'cpe3cw_trx';
	...
	{
		$this->_init('Customweb\PayEngine3Cw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\PayEngine3Cw\Model\Authorization\CustomerContext) {
				try {
		...
		if ($this->_registry->registry('initializeTransaction') !== false && $this->getTransactionObject() == null) {
			...
			/* @var $adapter \Customweb\PayEngine3Cw\Model\Authorization\Method\AbstractMethod */
