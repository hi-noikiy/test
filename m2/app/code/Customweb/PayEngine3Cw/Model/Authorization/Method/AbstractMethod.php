...
namespace Customweb\PayEngine3Cw\Model\Authorization\Method;
...
abstract class AbstractMethod
{
	...
	/**
	 * @var \Customweb\PayEngine3Cw\Model\Authorization\TransactionContextFactory
	 */
	...
	/**
	 * @var \Customweb\PayEngine3Cw\Model\ResourceModel\Authorization\Transaction\CollectionFactory
	 */
	protected $_transactionCollectionFactory;

	/**
	 * @var \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\Factory
	 */
	...
	/**
	 * @var \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext
	 */
	private $context;
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\TransactionContextFactory $transactionContextFactory
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\PayEngine3Cw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\Factory $contextFactory
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext $context
	 */
	public function __construct(
			...
			\Customweb\PayEngine3Cw\Model\Authorization\TransactionContextFactory $transactionContextFactory,
			\Customweb\PayEngine3Cw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\PayEngine3Cw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory,
			\Customweb\PayEngine3Cw\Model\Authorization\Method\Context\Factory $contextFactory,
			\Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext $context
	...
	/**
	 * @return \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext
	 */
	public function getContext()
	{
		if (!($this->context instanceof \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext)) {
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext $context
	 */
	public function setContext(\Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext $context)
	{
		$this->context = $context;
	}
	...
	public function initializeTransaction(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction)
	{
		
		$arguments = array(
			'transaction' => $transaction,
 		);
		return \Customweb_Licensing_PayEngine3Cw_License::run('hl3rb2uo7biinfdh', $this, $arguments);
	}

	final public function call_j5hlbfej485185gl() {
	...
	/**
	 * @return \Customweb\PayEngine3Cw\Model\Service\AuthorizationData
	 */
	public function startAuthorization()
	{
		$data = new \Customweb\PayEngine3Cw\Model\Service\AuthorizationData();
	...
	public function finishAuthorization()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_PayEngine3Cw_License::run('8jo6je9ajqtsu2ch', $this, $arguments);
	}

	final public function call_c5d5ku3eanpd52e3() {
		$arguments = func_get_args();
		$method = $arguments[0];
		$call = $arguments[1];
		$parameters = array_slice($arguments, 2);
	...
	/**
	 * @return \Customweb\PayEngine3Cw\Model\Authorization\Transaction|null
	 */
	...
	{
		if ($this->getContext()->getPaymentMethod() instanceof \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod) {
