...
class Factory
{
     ...
     */
    public function create(\Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\PayEngine3Cw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\PayEngine3Cw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\PayEngine3Cw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\PayEngine3Cw\Model\Authorization\Method\Context\Factory
     */
