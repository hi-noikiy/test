...
class OrderContext implements \Customweb_Payment_Authorization_IOrderContext
{
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod|string $paymentMethod
	 * @throws \Exception
	 */
	...
	private function assembleDataFromQuote(
		...
		$checkoutId = $checkoutSession->getPayEngine3CwCheckoutId();
		if(empty($checkoutId)){
			$checkoutId = \Customweb_Core_Util_Rand::getUuid();
			$checkoutSession->setPayEngine3CwCheckoutId($checkoutId);
		}
