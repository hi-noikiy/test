 ...
 * @method \Customweb\PayEngine3Cw\Model\Authorization\CustomerContext setContextId(string $value)
 * @method string getCustomerId()
 * @method \Customweb\PayEngine3Cw\Model\Authorization\CustomerContext setCustomerId(string $value)
 * @method array getValues()
 * @method \Customweb\PayEngine3Cw\Model\Authorization\CustomerContext setValues(array $value)
 * @method int getVersionNumber()
 * @method \Customweb\PayEngine3Cw\Model\Authorization\CustomerContext setVersionNumber(int $value)
 */
class CustomerContext extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_Authorization_IPaymentCustomerContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_payengine3cw_customer_context';
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\CustomerContextFactory $factory
	...
	public function __construct(
			...
			\Customweb\PayEngine3Cw\Model\Authorization\CustomerContextFactory $factory,
    ...
    {
        $this->_init('Customweb\PayEngine3Cw\Model\ResourceModel\Authorization\CustomerContext');
     ...
     * @return \Customweb\PayEngine3Cw\Model\Authorization\CustomerContext
     */
