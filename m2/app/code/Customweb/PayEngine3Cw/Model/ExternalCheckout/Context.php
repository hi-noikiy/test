...
namespace Customweb\PayEngine3Cw\Model\ExternalCheckout;

/**
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\PayEngine3Cw\Helper\InvoiceItem
	 */
	protected $_invoiceItemHelper;

	/**
	 * @var \Customweb\PayEngine3Cw\Helper\FoomanSurcharge
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_payengine3cw_external_checkout_context';
	...
	/**
	 * @var \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod
	 */
	 ...
	 * @param \Customweb\PayEngine3Cw\Helper\InvoiceItem $invoiceItemHelper
	 * @param \Customweb\PayEngine3Cw\Helper\FoomanSurcharge $foomanSurchargeHelper
	...
	public function __construct(
			...
			\Customweb\PayEngine3Cw\Helper\InvoiceItem $invoiceItemHelper,
			\Customweb\PayEngine3Cw\Helper\FoomanSurcharge $foomanSurchargeHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\PayEngine3Cw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod) {
			$data = [
