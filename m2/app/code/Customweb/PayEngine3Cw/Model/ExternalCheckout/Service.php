...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\PayEngine3Cw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\PayEngine3Cw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\PayEngine3Cw\Helper\ExternalCheckout $helper
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\OrderContextFactory $orderContextFactory
	 */
	public function __construct(
			...
			\Customweb\PayEngine3Cw\Helper\ExternalCheckout $helper,
			...
			\Customweb\PayEngine3Cw\Model\Authorization\OrderContextFactory $orderContextFactory
	) {
	...
	/**
	 * @param \Customweb\PayEngine3Cw\Model\DependencyContainer $container
	 * @return \Customweb\PayEngine3Cw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\PayEngine3Cw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\PayEngine3Cw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('payengine3cw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\PayEngine3Cw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('payengine3cw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\PayEngine3Cw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['payengine3cw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_payengine3cw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			$transaction = $this->_coreRegistry->registry('payengine3cw_transaction');
