...
class TransactionRepository implements \Customweb\PayEngine3Cw\Api\TransactionRepositoryInterface
{
	/**
    ...
    /**
     * @var \Customweb\PayEngine3Cw\Api\Data\TransactionInterfaceFactory
     */
	 ...
	 * @param \Customweb\PayEngine3Cw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	...
	public function __construct(
			...
			\Customweb\PayEngine3Cw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\PayEngine3Cw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\PayEngine3Cw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\PayEngine3Cw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\PayEngine3Cw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
