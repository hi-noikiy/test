...
class AuthorizationData implements \Customweb\PayEngine3Cw\Api\Data\AuthorizationDataInterface {
	...
	public function setHiddenFormFields(array $hiddenFormFields)
	{
		...
		foreach ($hiddenFormFields as $key => $value) {
			$field = new \Customweb\PayEngine3Cw\Model\Service\AuthorizationFormField();
