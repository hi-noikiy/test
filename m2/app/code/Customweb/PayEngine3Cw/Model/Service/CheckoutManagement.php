...
class CheckoutManagement implements \Customweb\PayEngine3Cw\Api\CheckoutManagementInterface
{
	/**
	...
	/**
	 *
	 * @var \Customweb\PayEngine3Cw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\Payment\Method\ConfigProvider $configProvider
	...
	public function __construct(
		...
		\Customweb\PayEngine3Cw\Model\Payment\Method\ConfigProvider $configProvider,
     ...
     * @param int $alias
     * @return string
     * @throws \Customweb\PayEngine3Cw\Model\Exception\OptimisticLockingException
     */
    ...
    /**
     *
     * @param \Customweb\PayEngine3Cw\Api\Data\AuthorizationFormFieldInterface[] $formValues
     * @return NULL|string[]
     */
    protected function convertFormValuesToMap(array $formValues = null) {
    		...
    		foreach ($formValues as $formValue) {
    			/* @var \Customweb\PayEngine3Cw\Api\Data\AuthorizationFormFieldInterface $formValue */
