...
namespace Customweb\PayEngine3Cw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\PayEngine3Cw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_payengine3cw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\PayEngine3Cw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_payengine3cw_transaction', 'entity_id');
    }
