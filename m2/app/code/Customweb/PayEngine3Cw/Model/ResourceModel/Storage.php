...
namespace Customweb\PayEngine3Cw\Model\ResourceModel;
...
class Storage extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_payengine3cw_storage_resource';
    ...
    {
        $this->_init('customweb_payengine3cw_storage', 'key_id');
    }
