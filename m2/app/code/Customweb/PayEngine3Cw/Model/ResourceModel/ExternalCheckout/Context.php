...
namespace Customweb\PayEngine3Cw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\PayEngine3Cw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_payengine3cw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_payengine3cw_external_checkout_context', 'context_id');
    }
