 ...
 * @method \Customweb\PayEngine3Cw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\PayEngine3Cw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\PayEngine3Cw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_payengine3cw_storage';
    ...
    {
        $this->_init('Customweb\PayEngine3Cw\Model\ResourceModel\Storage');
    }
