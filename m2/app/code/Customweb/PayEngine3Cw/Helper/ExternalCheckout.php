...
namespace Customweb\PayEngine3Cw\Helper;
...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	...
	/**
	 * @param \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context
	 * @return \Magento\Sales\Model\Order
	 */
	public function saveOrder(\Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context)
	{
		$context->getQuote()->collectTotals()->save();

		$isNewCustomer = false;
		switch ($context->getRegisterMethod()) {
			case \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\PayEngine3Cw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
