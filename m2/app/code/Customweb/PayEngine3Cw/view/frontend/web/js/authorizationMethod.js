	...
	var AuthorizationMethod = function(formElement, authorizationUrl) {
		...
		this.redirect = function(orderId) {
			...
			if (!customer.isLoggedIn()) {
				serviceUrl = urlBuilder.createUrl('/guest-carts/:cartId/payengine3cw/checkout/authorize', {
					cartId: quote.getQuoteId()
				});
			} else {
				serviceUrl = urlBuilder.createUrl('/carts/mine/payengine3cw/checkout/authorize', {});
			}
			return storage.post(
