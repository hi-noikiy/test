...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_PayEngine3Cw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('payengine3cw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('payengine3cw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('payengine3cw/externalCheckout/registerPost', ['_secure' => true]);
	}
