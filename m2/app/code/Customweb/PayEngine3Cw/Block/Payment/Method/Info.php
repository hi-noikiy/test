...
class Info extends \Magento\Payment\Block\Info
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_PayEngine3Cw::payment/method/info.phtml';
	...
	public function getMethod()
	{
		...
		if ($this->getTransaction() instanceof \Customweb\PayEngine3Cw\Model\Authorization\Transaction) {
	...
	{
		return $this->getUrl('payengine3cw/transaction/view', ['transaction_id' => $this->getTransaction()->getId()]);
	}
