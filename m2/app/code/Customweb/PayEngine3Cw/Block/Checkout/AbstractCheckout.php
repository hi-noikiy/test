...
namespace Customweb\PayEngine3Cw\Block\Checkout;
...
class AbstractCheckout extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @return \Customweb\PayEngine3Cw\Block\Checkout\AbstractCheckout
	 */
	...
	/**
	 * @param \Customweb\PayEngine3Cw\Model\Authorization\Method\AbstractMethod $adapter
	 * @return \Customweb\PayEngine3Cw\Block\Checkout\AbstractCheckout
	 */
	public function setAuthorizationAdapter(\Customweb\PayEngine3Cw\Model\Authorization\Method\AbstractMethod $adapter)
	{
	...
	{
		if (!($this->authorizationAdapter instanceof \Customweb\PayEngine3Cw\Model\Authorization\Method\AbstractMethod)) {
