...
namespace Customweb\PayEngine3Cw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('payengine3cw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('payengine3cw_transaction');
	}
	...
	{
		return $this->getUrl('payengine3cw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('payengine3cw/transaction/');
	}
}