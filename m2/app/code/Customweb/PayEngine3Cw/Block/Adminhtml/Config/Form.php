...
namespace Customweb\PayEngine3Cw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_PayEngine3Cw::payengine3cw/config/form.phtml';

	/**
	 * @var \Customweb\PayEngine3Cw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\PayEngine3Cw\Model\Config\Structure $formStructure,
	 * @param \Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\PayEngine3Cw\Model\Config\Structure $formStructure,
			\Customweb\PayEngine3Cw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
