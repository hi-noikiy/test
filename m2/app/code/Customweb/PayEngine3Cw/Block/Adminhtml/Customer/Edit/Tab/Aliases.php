...
namespace Customweb\PayEngine3Cw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\PayEngine3Cw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\PayEngine3Cw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\PayEngine3Cw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('payengine3cw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('payengine3cw/customer/aliases', ['_current' => true]);
    }
    ...
    {
    	return __('Concardis PayEngine 3.0 Aliases');
    }
