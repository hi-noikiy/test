...
namespace Customweb\PayEngine3Cw\Block\Adminhtml\Sales\Order\Invoice\Create;
...
class Components extends \Magento\Framework\View\Element\Template
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_PayEngine3Cw::sales/order/invoice/create/components.phtml';
	...
	public function canCaptureNoClose()
	{
		...
		if (!($invoice->getOrder()->getPayment()->getMethodInstance() instanceof \Customweb\PayEngine3Cw\Model\Payment\Method\AbstractMethod)) {
			return false;
		}
