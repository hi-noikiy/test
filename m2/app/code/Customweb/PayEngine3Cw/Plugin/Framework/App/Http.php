...
namespace Customweb\PayEngine3Cw\Plugin\Framework\App;

class Http
{

	/**
	 * @var \Customweb\PayEngine3Cw\Model\Logging\Listener
	 */
	private $_loggingListener;

	/**
	 * @param \Customweb\PayEngine3Cw\Model\Logging\Listener $loggingListener
	 */
	public function __construct(
			\Customweb\PayEngine3Cw\Model\Logging\Listener $loggingListener
	) {
	...
	{
		\Customweb_I18n_Translation::getInstance()->addResolver(new \Customweb\PayEngine3Cw\Model\TranslationResolver());
	}
