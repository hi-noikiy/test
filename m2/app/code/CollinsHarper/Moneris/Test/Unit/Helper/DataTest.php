 ...
 */
namespace CollinsHarper\Moneris\Test\Unit\Helper;
...
class DataTest extends \PHPUnit_Framework_TestCase
{
     ...
     * moneris helper
     *
     * @var \CollinsHarper\Moneris\Helper\Config
     */
    protected $_model;
    ...
    public function setUp()
    {
        ...
        $this->helper = $objectManagerHelper->getObject('CollinsHarper\Moneris\Helper\Data');
