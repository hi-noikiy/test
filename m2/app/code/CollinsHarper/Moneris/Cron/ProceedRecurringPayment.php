...
namespace CollinsHarper\Moneris\Cron;

use CollinsHarper\Moneris\Helper\Data;
use CollinsHarper\Moneris\Model\RecurringPaymentQueue;
use CollinsHarper\Moneris\Model\ResourceModel\RecurringPaymentQueue as ResourceQueueModel;
use CollinsHarper\Moneris\Model\RecurringPaymentQueueFactory;
...
use CollinsHarper\Moneris\Model\ResourceModel\RecurringPayment\Collection;
use CollinsHarper\Moneris\Model\ResourceModel\RecurringPayment\CollectionFactory;
use CollinsHarper\Moneris\Model\Transaction;
use CollinsHarper\Moneris\Logger\Logger;
    ...
    public function proceedQueue()
    {
        ...
        foreach ($collection as $queueItem) {
            ...
            if ($data['status_code'] === '005') {
                ...
                echo $queueItemData['moneris_order_id'] . " is still not proceeded in Moneris";
            }
        }
    }
