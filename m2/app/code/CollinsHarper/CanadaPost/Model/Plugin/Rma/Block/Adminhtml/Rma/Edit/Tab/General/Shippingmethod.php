 ...
 */
namespace CollinsHarper\CanadaPost\Model\Plugin\Rma\Block\Adminhtml\Rma\Edit\Tab\General;
...
class Shippingmethod
{
    ...
    public function afterCanDisplayCustomValue(\Magento\Framework\DataObject $subject, $result)
    {
        ...
        return (bool)$result || (bool)$carrierCode == \CollinsHarper\CanadaPost\Model\Carrier::CODE;
    }
}
