...
class CarrierTestCopy extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testCollectRates()
    {
        ...
        $this->_httpResponse->expects(
            ...
            $this->returnValue(file_get_contents(__DIR__ . '/_files/success_canadapost_response_rates   .xml'))
        );
        // for setRequest
        $request = $this->_helper->getObject(
            'Magento\Quote\Model\Quote\Address\RateRequest',
            require __DIR__ . '/_files/rates_request_canadapost_data.php'
        );
    ...
    public function testCollectRatesErrorMessage()
    {
        ...
        $this->error->expects($this->once())->method('setCarrier')->with('cpcanadapost');
