...
namespace CollinsHarper\Masterpass\Controller\Index;

use CollinsHarper\Masterpass\Model\Ui\ConfigProvider;
...
class Receipt extends \Magento\Framework\App\Action\Action
{
    ...
    /**
     *
     * @var \CollinsHarper\Masterpass\Gateway\Config\Config
     */
    protected $_config;
    ...
    public function __construct(
        ...
        \CollinsHarper\Masterpass\Service\Transaction $transaction,
        \CollinsHarper\Masterpass\Gateway\Config\Config $config,
...
//                'dynamic_descriptor'=>'123456'
    ...
    private function placeOrder($processResponse)
    {
        ...
        $quote->setPaymentMethod(\CollinsHarper\Masterpass\Model\Ui\ConfigProvider::MCODE);
        $quote->setInventoryProcessed(false);

        // Set Sales Order Payment
        $quote->getPayment()->importData(['method' => \CollinsHarper\Masterpass\Model\Ui\ConfigProvider::MCODE]);
