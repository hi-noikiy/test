 ...
 */
namespace CollinsHarper\Masterpass\Block\Test\Unit\Controller\Index;
...
class ReceiptTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->transactionMock = $this
            ->getMockBuilder(\CollinsHarper\Masterpass\Service\Transaction::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->unit = $helper->getObject(
            \CollinsHarper\Masterpass\Controller\Index\Receipt::class,
            [
