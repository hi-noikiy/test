 ...
 */
namespace CollinsHarper\Masterpass\Block\Test\Unit\Block;
...
class FormTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->gatewayConfig = $this
            ->getMockBuilder(\CollinsHarper\Masterpass\Gateway\Config\Config::class)
            ->setMethods([
            ...
            ->getMock();
        $this->ccType = $this
            ->getMockBuilder(\CollinsHarper\Masterpass\Model\Source\CcType::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->unit = $helper->getObject(
            \CollinsHarper\Masterpass\Block\Form::class,
            [
