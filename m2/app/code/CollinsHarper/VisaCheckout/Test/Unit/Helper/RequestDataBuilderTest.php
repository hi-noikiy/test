 ...
 */
namespace CollinsHarper\VisaCheckout\Block\Test\Unit\Helper;
...
class RequestDataBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->gatewayConfigMock = $this
            ->getMockBuilder(\CollinsHarper\VisaCheckout\Gateway\Config\Config::class)
            ->disableOriginalConstructor()
        ...
        $this->unit = $helper->getObject(
            \CollinsHarper\VisaCheckout\Helper\RequestDataBuilder::class,
            [
