...
use Amasty\Affiliate\Model\ResourceModel\Account\CollectionFactory as AccountCollectionFactory;
...
class InstallData implements InstallDataInterface
{
     ...
     * @param \Magento\SalesRule\Api\Data\RuleInterfaceFactory $ruleFactory
    ...
    public function __construct(
        ...
        \Magento\SalesRule\Api\Data\RuleInterfaceFactory $ruleFactory,
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $this->_createCmsPages();
        $this->_createShoppingCartRule();

        $this->setup->endSetup();
    }

    protected function _createCmsPages()
    {
...
<ol>
    ...
    <li><b>Termination</b>
        Either <a href="{{store url=""}}">{{store url=""}}</a> or the affiliate may terminate this Agreement at any time, with or without cause.
        Once the agreement is terminated, you should remove all links to the <a href="{{store url=""}}">{{store url=""}}</a> website as well as all
...
EOD;
    ...
    protected function _createShoppingCartRule()
    {
