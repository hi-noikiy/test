...
class Mailsender
{
    const TYPE_ADMIN_NEW_WITHDRAWAL = 'admin_new_withdrawal';
    const TYPE_ADMIN_NEW_ACCOUNT = 'admin_new_account';

    const TYPE_AFFILIATE_WITHDRAWAL_STATUS = 'withdrawal_changed';
    const TYPE_AFFILIATE_TRANSACTION_STATUS = 'transaction_changed';
    const TYPE_AFFILIATE_TRANSACTION_NEW = 'transaction_created';
    const TYPE_AFFILIATE_STATUS = 'affiliate_status';
    const TYPE_AFFILIATE_WELCOME = 'affiliate_welcome';
