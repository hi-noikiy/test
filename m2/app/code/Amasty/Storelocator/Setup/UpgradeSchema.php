...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    /**
     * @var Operation\UpgradeDataTo202
     */
    private $upgradeDataTo202;
    ...
    public function __construct(
        ...
        Operation\UpgradeDataTo202 $upgradeDataTo202
    ) {
        ...
        $this->upgradeDataTo202 = $upgradeDataTo202;
    }
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if ($context->getVersion()) {
            ...
            if (version_compare($context->getVersion(), '2.0.0', '<')) {
                ...
                $this->upgradeDataTo200->addMetaData($setup, $context);
                $this->upgradeDataTo200->execute($setup, $context);
                $this->createReviewTable->execute($setup);
            }

            if (version_compare($context->getVersion(), '2.0.2', '<')) {
                $this->upgradeDataTo202->addCanonicalUrl($setup);
            }
        }
