...
class ScheduleDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    {
        $configuration = &$this->meta['general']['children'][$key]['children'][$timeKey]['children'][$unitsKey]['arguments']['data']['config'];
    ...
    {
        $configuration = &$this->meta['general']['children'][$key]['children']['fill_schedule_button']['arguments']['data']['config'];
