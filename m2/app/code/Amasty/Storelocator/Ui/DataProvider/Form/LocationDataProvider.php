...
class LocationDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
            ...
            if ($locationModel->getMarkerImg()) {
                ...
                $locationData['marker_img'] = [
                    [
                        ...
                        'url' => $this->imageProcessor->getImageUrl([ImageProcessor::AMLOCATOR_MEDIA_PATH, $locationData['id'], $markerName])
                    ]
                ];
            }
            ...
            if (!empty($galleryImages)) {
                ...
                foreach ($galleryImages as $image) {
                    ...
                    array_push(
                        ...
                        [
                            'name' => $imgName,
                            'url' => $this->imageProcessor->getImageUrl([ImageProcessor::AMLOCATOR_GALLERY_MEDIA_PATH, $locationData['id'], $imgName])
                        ]
                    );
    ...
    public function getMeta()
    {
        ...
        $attributes = $this->attributeCollection->preparedAttributes();
    ...
    {
        $configuration = &$this->meta['store_attribute']['children'][$attributeData['attribute_id']]['arguments']['data']['config'];
