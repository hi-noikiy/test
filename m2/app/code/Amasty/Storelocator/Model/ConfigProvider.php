...
class ConfigProvider
{
    ...
    {
        return $this->getValue(self::XPATH_CLOSED_TEXT, $scopeCode);
    }
    ...
    {
        return $this->getValue(self::XPATH_BREAK_TEXT, $scopeCode);
    }
    ...
    public function getLinkText($scopeCode = null)
    {
        ...
        return !empty($linkText) ? $linkText : 'Available In Stores';
    }
    ...
    {
        return $this->getValue(self::XPATH_LABEL, $scopeCode);
    }
}
