 ...
 */
namespace Ktpl\Checkout\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    public function getWebsiteCode()
    {
        $websites = $this->_storeManager->getWebsites();
            ...
            foreach ($websites as $website) {
                if($website->getId() == $this->_storeManager->getStore()->getWebsiteId()){
    ...
    public function collectRates(RateRequest $request)
    {
        ...
        /* If ares is frontend then return false for disable shipping method at
        frontend*/

        $websiteArray = array('tvape_german_migrated','vaporizera_migrated');
        if(in_array($this->getWebsiteCode(),$websiteArray)){
