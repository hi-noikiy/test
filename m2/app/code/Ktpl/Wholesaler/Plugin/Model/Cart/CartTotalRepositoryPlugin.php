...
namespace Ktpl\Wholesaler\Plugin\Model\Cart;
...
class CartTotalRepositoryPlugin
{
    ...
    public function aroundGet(TotalRepository $subject, \Closure $proceed, $cartId)
    {
        ...
        $extensionAttributes->setTierDiscount($quote->getTierDiscount());
        $extensionAttributes->setBaseTierDiscount($quote->getBaseTierDiscount());
