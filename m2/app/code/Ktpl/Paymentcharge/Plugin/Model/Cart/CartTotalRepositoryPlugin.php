...
namespace Ktpl\Paymentcharge\Plugin\Model\Cart;
...
class CartTotalRepositoryPlugin
{
    ...
    public function aroundGet(TotalRepository $subject, \Closure $proceed, $cartId)
    {
        ...
        $extensionAttributes->setPaymentCharge($quote->getPaymentCharge());
        $extensionAttributes->setBasePaymentCharge($quote->getBasePaymentCharge());
