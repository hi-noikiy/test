...
define(
    [
        ...
        'Ktpl_Paymentcharge/js/view/checkout/paymentcharge',
    ...
    function (ko, $, storage, Component, quote, getTotalsAction, urlBuilder, mageUrlBuilder, fullScreenLoader, cashondelivery, customer, totals) {
        ...
        return Component.extend({
            defaults: {
                template: 'Ktpl_Paymentcharge/payment/paymentcharge-form'
            },
            ...
            refreshMethod: function () {
                ...
                return storage.put(
                    ...
                    cashondelivery.canShowCashOnDelivery(quote.paymentMethod().method == 'classyllama_llamacoin');
                    getTotalsAction([]);
...
//                });
                ...
                quote.paymentMethod.subscribe(function () {
                    if (quote.paymentMethod().method != me.lastDetectedMethod) {
                        if (
                            (quote.paymentMethod().method == 'classyllama_llamacoin') ||
                            (me.lastDetectedMethod == 'classyllama_llamacoin') ||
                            (totals.getSegment('classyllama_llamacoin') && (me.lastDetectedMethod === null))
                        ) {
                            me.refreshMethod();
                        }
