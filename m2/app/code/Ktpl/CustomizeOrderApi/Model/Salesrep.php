<?php
namespace Ktpl\CustomizeOrderApi\Model;

use \Ktpl\CustomizeOrderApi\Api\Data\SalesrepInterface;
...
class Salesrep extends \Magento\Framework\Model\AbstractModel implements SalesrepInterface, IdentityInterface
{
    ...
    {
        $this->_init('Ktpl\CustomizeOrderApi\Model\ResourceModel\Salesrep');
    }
